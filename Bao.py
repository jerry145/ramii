...
\033[1;96m---------------------SAQII UR D4D---------------------
                
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92m Saqii D'Lewixx .                                
\033[0;91m║\033[0;91mWhatsapp number :\033[0;92m "+923437791416"                                                                                         
\033[0;95m╰════════════════════════════════════════════╯
             
                
\033[1;96m-----------------Ruk Ja Ramii ----------------------
"""
...
\033[1;99m If you face any problem contact me on Whatsapp +923437791416💜
 
\033[1;96m------------------THE SAQII💜HACKER----------------------
 
 
\033[0;95m╭════════════════════════════════════════════╮
\033[0;91m║\033[0;92mAUTHOR : \033[0;92mSaqii D'Lewixx .                                   
\033[0;91m║\033[0;91mWhatsapp number:\033[0;92m "+923437791416 "                                           
\033[0;95m╰════════════════════════════════════════════╯
 
\033[1;96m-----------------SAQII💜HACKER------------------------
"""
logo2 = """
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://youtu.be/kLdkMgb914Y ')
    else:
...
def action():
    ...
    print 50* '\033[1;94m-'
    xxx = str(len(id))
    jalan('\033[1;96m▬PROGRAMED BY Saqii D'Lewixx')
